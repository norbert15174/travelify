    ...
    return (
        <>
            ...
            <Buttons>
                ...
                <Submit disabled={description === initialDescription || putting} type="submit" onClick={onSubmit}>Zapisz</Submit>
                <Cancel disabled={description === initialDescription || putting} onClick={() => setDescription(data)}>Anuluj</Cancel>
            </Buttons>
        </>
    );
